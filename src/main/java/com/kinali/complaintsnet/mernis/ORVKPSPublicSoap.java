...
public class ORVKPSPublicSoap
{
    ...
    public ORVKPSPublicSoap(){}

    public ORVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ORVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ORVExtendedSoapSerializationEnvelope envelope= new ORVExtendedSoapSerializationEnvelope(ORVExtendedSoapSerializationEnvelope.VER11);
