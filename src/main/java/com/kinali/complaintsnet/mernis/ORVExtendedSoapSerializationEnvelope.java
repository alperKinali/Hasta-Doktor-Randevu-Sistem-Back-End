...
public class ORVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ORVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ORVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ORVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ORVDateTimeConverter dateTimeConverter = new ORVStandardDateTimeConverter();

    public ORVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ORVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ORVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ORVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ORVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ORVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
